...
<div class="flex flex-col gap-2 font-semibold sm:flex-row-reverse">
  <button
    id="delete-button"
    class="h-10 w-full select-none rounded-md bg-teal-400 px-4 py-2 font-medium text-white shadow-md shadow-teal-400/50 outline-none hover:bg-teal-500 focus:ring-2 focus:ring-teal-600 sm:w-28">
    Delete
  </button>
  <button
    id="cancel-button"
